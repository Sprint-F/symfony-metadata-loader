...
COMPOSE=PROJECT=$(PROJECT) ENV=$(ENV) UID=$(UID) GID=$(GID) docker compose --project-name=$(PROJECT) -f docker-compose.yaml -f docker-compose.$(ENV).yaml -f docker-compose.mode-compose.yaml
